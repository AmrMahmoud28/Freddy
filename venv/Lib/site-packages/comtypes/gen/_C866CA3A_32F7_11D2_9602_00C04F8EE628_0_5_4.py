...
__all__ = [
    'SPLO_STATIC', 'SRCS_Enabled', 'SPLOADOPTIONS',
    'DISPID_SPERequiredConfidence', 'DISPID_SpeechPhraseRule',
    'SPWORD', 'DISPID_SpeechRecognizerStatus', 'SpWaveFormatEx',
    'DISPID_SPRsCount', 'SPEI_RESERVED2',
    'DISPID_SRRTOffsetFromStart', 'SPBO_NONE', 'SVEPhoneme', 'SLTApp',
    'SVEAudioLevel', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SRCBookmark',
    'SPGS_EXCLUSIVE', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SpeechPhraseInfo', 'IInternetSecurityManager',
    'DISPID_SVResume', 'eLEXTYPE_PRIVATE4', 'SpeechTokenShellFolder',
    'SPSEMANTICFORMAT', 'SPGS_DISABLED', 'SPCATEGORYTYPE',
    'SPDKL_CurrentConfig', 'eLEXTYPE_VENDORLEXICON', 'SRTReSent',
    'SITooFast', 'SPPHRASERULE', 'SpeechTokenIdUserLexicon', 'SVP_5',
    'SFTInput', 'DISPID_SPPParent', 'SpeechWordType', 'SP_VISEME_19',
    'ISpShortcut', 'SECFNoSpecialChars',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SGRSTsCount',
    'ISpeechRecoResult2', 'DISPID_SPPs_NewEnum', 'SpLexicon',
    'DISPID_SRCRecognizer', 'DISPID_SRCEBookmark', 'SSTTTextBuffer',
    'DISPID_SBSRead', 'SpInprocRecognizer', 'SDKLCurrentUser',
    'SPINTERFERENCE_TOOFAST', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVEStreamStart', 'SPWT_PRONUNCIATION',
    'DISPID_SRCAudioInInterferenceStatus', 'SPSHORTCUTPAIRLIST',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPINTERFERENCE_TOOLOUD',
    'SpShortcut', 'DISPID_SpeechDataKey', 'SP_VISEME_16', 'SPPHRASE',
    'DISPID_SPPValue', 'SPEI_MAX_TTS', 'SPEI_SR_PRIVATE',
    ...
    'SPBO_PAUSE', 'SPAR_Unknown', 'DISPID_SLGetPronunciations',
    'DISPID_SVSkip', 'SpMMAudioIn', 'ISpeechMMSysAudio',
    'SPSHT_EMAIL', 'DISPID_SDKSetLongValue', 'SAFT32kHz8BitStereo',
    'SPCT_SUB_COMMAND', 'eLEXTYPE_RESERVED8', 'SRERecognition',
    'ISpStreamFormatConverter', 'DISPID_SLGetGenerationChange',
    'SPRULESTATE', 'DISPID_SPRDisplayAttributes',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SDKOpenKey',
    'DISPID_SPIElements', 'SPEVENTENUM', 'eLEXTYPE_MORPHOLOGY',
    'SRADynamic', 'DISPID_SRGRules', 'DISPID_SpeechAudioStatus',
    'SPEI_REQUEST_UI', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPEAudioTimeOffset', 'SGPronounciation', 'DISPID_SGRName',
    'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVF_Stressed',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPEsItem', 'SECFDefault',
    'SWTDeleted', 'SPRST_INACTIVE', 'SPSTREAMFORMATTYPE',
    'SpSharedRecognizer', 'SPEI_SOUND_END', 'SPWF_INPUT',
    'SPSModifier', 'SAFTADPCM_11kHzMono', 'SECNormalConfidence',
    'DISPID_SpeechRecoContext', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRCPause', 'SAFT48kHz8BitStereo', 'SVEViseme',
    'SPFM_CREATE_ALWAYS', 'SPINTERFERENCE_TOOQUIET', 'ISpDataKey',
    'SAFTGSM610_44kHzMono', 'SPWT_DISPLAY', 'eLEXTYPE_PRIVATE16',
    'SPPS_Function', 'SECFIgnoreWidth', 'SECFIgnoreKanaType',
    'SpeechLexiconType', 'Speech_StreamPos_Asap', 'SGRSTTTextBuffer',
    'SWPUnknownWordPronounceable', 'SREBookmark', 'SGRSTTEpsilon',
    'ISpeechRecognizer', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SVEPhoneme', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechPhraseElement', 'SINoSignal', 'SPCT_SUB_DICTATION',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPELexicalForm', 'DISPID_SLGenerationId',
    'STSF_FlagCreate', 'DISPID_SGRSRule', 'SPSMF_SAPI_PROPERTIES',
    'SPXRO_SML', 'DISPID_SpeechPhraseRules', 'SAFT44kHz8BitStereo',
    'DISPID_SGRSTText', 'SpeechPartOfSpeech', 'DISPID_SLPsCount',
    'DISPID_SVEViseme', 'SREStreamEnd', 'SpCompressedLexicon',
    'SVP_3', 'SRSInactive', 'SVP_16', 'SPWORDLIST',
    'SpeechPropertyResponseSpeed', 'SpeechAudioFormatType',
    'DISPID_SVEBookmark', 'DISPID_SRCERecognitionForOtherContext',
    'ISpeechRecoResultDispatch', 'SPINTERFERENCE',
    'SpeechTokenKeyAttributes', 'DISPID_SPPChildren', 'SRERequestUI',
    'DISPID_SPIProperties', 'DISPID_SPAPhraseInfo', 'SPSVerb',
    'SAFT48kHz8BitMono', 'SpeechRegistryUserRoot',
    'DISPID_SpeechPhraseElements', 'SPSInterjection',
    'STCInprocHandler', 'SP_VISEME_20', 'SVP_9',
    'SAFT44kHz16BitStereo', 'ISpProperties', 'SBOPause',
    'ISpeechPhraseElement', 'SP_VISEME_2', 'SP_VISEME_8',
    'DISPID_SRAudioInputStream', 'SDTDisplayText', 'SpStream',
    'DISPID_SLWLangId', 'DISPID_SPIGetText',
    'DISPID_SPERetainedStreamOffset', 'SPSHORTCUTTYPE',
    'eWORDTYPE_DELETED', 'STSF_AppData', 'DISPID_SPILanguageId',
    'ISpeechLexiconWords', 'IStream', 'SAFTDefault',
    'SPXRO_Alternates_SML', 'SWPKnownWordPronounceable',
    'DISPID_SRRSetTextFeedback', 'SREAudioLevel',
    'DISPID_SVESentenceBoundary', 'SPEVENT', 'ISpeechVoice',
    'DISPID_SDKDeleteKey', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPEPronunciation', 'eLEXTYPE_PRIVATE9',
    'SpeechPropertyResourceUsage', 'SPEVENTSOURCEINFO',
    'DISPID_SPCPhoneToId', 'DISPID_SVSVisemeId', 'SPAUDIOBUFFERINFO',
    'SVP_0', 'ISpObjectWithToken', 'ISpeechAudioStatus',
    'ISpeechCustomStream', 'DISPID_SAFSetWaveFormatEx',
    'tagSPPROPERTYINFO', 'SP_VISEME_1', 'WAVEFORMATEX',
    'SpeechAudioVolume', 'DISPID_SRCRequestedUIType',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SWFESamplesPerSec',
    'SECHighConfidence', 'SPPS_RESERVED1', 'SpeechRuleState',
    'SpCustomStream', 'DISPID_SLWType', 'SVSFlagsAsync',
    'DISPID_SPEAudioSizeBytes', 'SVP_19', 'DISPID_SLPPhoneIds',
    'DISPID_SRRPhraseInfo', 'DISPID_SWFEExtraData',
    'DISPID_SPPNumberOfElements', 'eLEXTYPE_PRIVATE2',
    'eLEXTYPE_PRIVATE7', 'SPBO_AHEAD', 'DISPID_SDKEnumKeys',
    '_ISpeechRecoContextEvents', 'DISPID_SRStatus',
    'SPWORDPRONOUNCEABLE', 'SPEI_RECO_STATE_CHANGE',
    'ISpeechBaseStream', 'DISPID_SOTGetStorageFileName',
    'SP_VISEME_17', 'SAFT24kHz8BitStereo',
    'DISPID_SPEEngineConfidence', 'DISPID_SpeechAudio',
    'ISpeechXMLRecoResult', 'DISPID_SVSpeakStream',
    'SPINTERFERENCE_NOISE', 'SpUnCompressedLexicon',
    'SAFTADPCM_8kHzMono', 'DISPID_SPIEnginePrivateData',
    'SPLO_DYNAMIC', 'SPEI_MIN_SR', 'SpeechVoiceSkipTypeSentence',
    'SGDSActiveWithAutoPause', 'DISPID_SLRemovePronunciation',
    'ISpeechPhraseProperty', 'SDKLCurrentConfig', 'SpMMAudioEnum',
    'DISPID_SRProfile', 'DISPID_SRCEventInterests',
    'SAFT24kHz8BitMono', 'DISPID_SVEEnginePrivate', 'STCAll',
    'SpeechPropertyLowConfidenceThreshold', 'SRARoot',
    'SPBOOKMARKOPTIONS', 'SPEI_HYPOTHESIS',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_MIN_TTS',
    'DISPID_SVAudioOutput', 'SVSFParseSsml', 'SAFT22kHz8BitMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRsFindRule', 'SVEPrivate',
    'DISPID_SRDisplayUI', 'SBONone', 'SAFT44kHz8BitMono',
    'SpeechCategoryAppLexicons', 'SPEI_SENTENCE_BOUNDARY',
    'SAFTADPCM_22kHzMono', 'SAFTTrueSpeech_8kHz1BitMono', 'SGDisplay',
    'SPRST_NUM_STATES', 'DISPID_SGRSAddWordTransition',
    'SPRST_ACTIVE', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SGRsCommit', 'SpMMAudioOut', 'SPAR_Low', 'SPAUDIOSTATE',
    'SGSExclusive', 'DISPID_SRGetPropertyString',
    'SpeechEngineProperties', 'DISPID_SLPsItem',
    'DISPID_SPARecoResult', 'STCLocalServer',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPPsCount', 'SPPS_LMA',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPEDisplayAttributes',
    'DISPID_SOTCategory', 'DISPID_SRSAudioStatus', 'SDTLexicalForm',
    'SECFIgnoreCase', '__MIDL_IWinTypes_0009', 'DISPID_SOTDataKey',
    '_SPAUDIOSTATE', 'DISPID_SGRId', 'SRAExport',
    'DISPID_SDKSetStringValue', 'DISPID_SRGCmdLoadFromMemory',
    'SAFT8kHz8BitMono', 'ISpeechRecoResult', 'SLTUser',
    'DISPID_SGRSTNextState', 'SDA_Two_Trailing_Spaces',
    'DISPID_SVEStreamEnd', 'DISPID_SOTCId', 'ISpNotifySource',
    'DISPID_SOTMatchesAttributes', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'Speech_Default_Weight', 'SRSInactiveWithPurge',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SVPriority',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPEActualConfidence',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRRAlternates', 'SGSEnabled',
    'eLEXTYPE_PRIVATE20', 'SAFT16kHz16BitMono', 'ISpRecognizer',
    'SPSMF_SRGS_SAPIPROPERTIES', 'eLEXTYPE_PRIVATE5',
    'SAFT8kHz16BitMono', 'SAFTCCITT_ALaw_44kHzMono', 'ISpPhrase',
    'ISpeechDataKey', 'SpeechDictationTopicSpelling', 'SINoise',
    'DISPID_SOTCSetId', 'SPEI_RESERVED5', 'ISpeechResourceLoader',
    'ISpeechLexicon', 'SPDKL_DefaultLocation', 'SREStateChange',
    'eLEXTYPE_PRIVATE6', 'SPAR_High', 'DISPID_SPRuleChildren',
    'DISPID_SWFEBitsPerSample', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRCreateRecoContext', 'ISpeechGrammarRule',
    'Speech_StreamPos_RealTime', 'DISPID_SOTGetDescription',
    'DISPID_SPAs_NewEnum', 'SPRECOGNIZERSTATUS', 'SPPS_Modifier',
    'SP_VISEME_21', 'Speech_Max_Pron_Length',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SVAlertBoundary', 'SPPHRASEREPLACEMENT', 'SPAO_NONE',
    'eLEXTYPE_PRIVATE3', 'SAFT11kHz8BitStereo',
    'DISPIDSPTSI_SelectionLength', 'SREPropertyStringChange',
    'SREAdaptation', 'SPSUnknown', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRCERequestUI', 'DISPID_SVPause', 'DISPID_SBSWrite',
    'SpObjectToken', 'SVPOver', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechRecoResult', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPIGrammarId', 'DISPID_SABufferNotifySize', 'SVP_2',
    ...
    'DISPID_SCSBaseStream', 'SGLexicalNoSpecialChars', 'DISPID_SPPId',
    'ISpeechGrammarRuleStateTransition', 'SPCT_COMMAND',
    'SAFT12kHz8BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SGLexical',
    'tagSTATSTG', 'ISpStreamFormat', 'DISPID_SPEDisplayText',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRCSetAdaptationData',
    'DISPID_SDKDeleteValue', 'SVSFIsXML', 'SPWT_LEXICAL',
    'SPEI_RECO_OTHER_CONTEXT', 'eLEXTYPE_USER', 'ISpXMLRecoResult',
    'DISPID_SRCEPhraseStart', 'SAFT8kHz8BitStereo',
    'DISPID_SWFEFormatTag', 'DISPID_SVSInputSentenceLength',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_4', 'SPVPRI_NORMAL',
    'SAFTGSM610_11kHzMono', 'DISPID_SRRTimes',
    'DISPID_SDKSetBinaryValue', 'DISPID_SVEVoiceChange', 'SASPause',
    'DISPID_SAEventHandle', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechCustomStream',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SGRSTPropertyName', '_RemotableHandle', 'ISpRecoResult',
    'DISPID_SABIBufferSize', 'SAFTNoAssignedFormat', 'SP_VISEME_4',
    'DISPID_SPCLangId', 'ISpeechPhraseElements',
    'SAFTCCITT_ALaw_8kHzMono', 'SPVPRIORITY', 'DISPID_SGRsCount',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SBSSeek',
    'ISpeechMemoryStream', 'ISpeechWaveFormatEx', 'DISPID_SMSSetData',
    'DISPID_SMSADeviceId', 'SRAInterpreter', 'eLEXTYPE_PRIVATE10',
    'ISpeechGrammarRuleStateTransitions', 'SGRSTTRule',
    'SAFTADPCM_8kHzStereo', 'SP_VISEME_11', 'DISPID_SPRuleParent',
    'SPFM_OPEN_READWRITE', 'SPSSuppressWord',
    'DISPID_SpeechLexiconProns', 'SRSEDone', 'SREStreamStart',
    'DISPID_SRGSetWordSequenceData', 'ISpeechPhraseProperties',
    'ISpRecoContext', 'DISPID_SVVolume', 'eLEXTYPE_PRIVATE17',
    'SPSNotOverriden', 'SVP_15', 'ISpeechObjectTokenCategory',
    'DISPID_SGRs_NewEnum', 'SPWF_SRENGINE', 'SPVOICESTATUS',
    'DISPID_SRCESoundStart', 'DISPID_SRCESoundEnd', 'SDTProperty',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCCreateGrammar',
    'DISPID_SPEsCount', 'DISPID_SGRAttributes',
    'SpeechAudioProperties', 'SpeechDiscardType', 'SVF_Emphasis',
    'ISpeechRecoResultTimes', 'SVSFPurgeBeforeSpeak',
    'STSF_CommonAppData', 'DISPID_SVGetProfiles', 'eWORDTYPE_ADDED',
    'DISPID_SVSPhonemeId', 'SP_VISEME_0', 'SPPS_RESERVED4',
    'SVPAlert', 'SpeechPropertyAdaptationOn', 'SSTTWildcard',
    'ISpeechObjectTokens', 'DISPID_SGRAddState',
    'DISPID_SpeechLexiconPronunciation', 'SP_VISEME_18',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPRuleNumberOfElements',
    'SAFTADPCM_44kHzStereo', 'SRTExtendableParse',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechObjectTokens',
    'DISPID_SPRsItem', 'DISPID_SVEWord', 'eLEXTYPE_RESERVED10',
    'DISPID_SPRText', 'SP_VISEME_15', 'SLOStatic',
    'SpeechTokenValueCLSID', 'ISpeechObjectToken', 'SVP_12',
    'SPRS_INACTIVE', 'SpeechTokenKeyUI', 'SpeechAudioState',
    'ISpEventSource', 'DISPID_SpeechGrammarRule',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpInProcRecoContext', 'SVP_1', 'SAFTExtendedAudioFormat',
    'DISPID_SLPs_NewEnum', 'DISPID_SABufferInfo', 'SVP_10',
    'DISPID_SPPName', 'SPAS_CLOSED', 'SP_VISEME_7',
    'SPSERIALIZEDRESULT', 'SPEI_TTS_BOOKMARK', 'DISPID_SRCState',
    'DISPID_SpeechWaveFormatEx', 'SP_VISEME_14',
    'ISpeechPhraseReplacement', 'DISPID_SGRSTransitions',
    'SpeechAudioFormatGUIDWave', 'SP_VISEME_10', 'DISPID_SOTsItem',
    'SRTStandard', 'DISPID_SASState', 'SPEI_ADAPTATION',
    'DISPID_SpeechFileStream', 'DISPID_SOTRemoveStorageFileName',
    'ISpNotifyTranslator', 'SAFT11kHz8BitMono',
    'SAFT22kHz16BitStereo', 'DISPID_SGRsDynamic',
    'DISPID_SLWs_NewEnum', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SLWPronunciations', 'SpeechVoiceEvents',
    'DISPID_SVIsUISupported', 'SPEI_RECOGNITION', 'SASStop',
    'DISPID_SVEAudioLevel', 'DISPID_SRSCurrentStreamPosition',
    'SAFT32kHz16BitStereo', 'eLEXTYPE_PRIVATE1', 'SVP_20',
    'SpeechEngineConfidence', 'ISpRecoContext2',
    'ISpeechGrammarRuleState', 'SpeechGrammarState',
    'DISPID_SPRuleName', 'DISPID_SRRSpeakAudio', 'SGSDisabled',
    'SPBO_TIME_UNITS', 'DISPID_SGRsCommitAndSave',
    'ISpeechLexiconPronunciation', 'SVEStartInputStream',
    'DISPID_SRGetRecognizers', 'DISPID_SRCEFalseRecognition',
    ...
    'DISPID_SPPConfidence', 'SASClosed', 'DISPID_SGRSTPropertyValue',
    'SPRS_ACTIVE', 'SpeechRecognizerState', 'SPEI_MAX_SR',
    'DISPID_SVGetAudioInputs', 'SP_VISEME_9', 'STCRemoteServer',
    'SGDSActive', 'SPCT_SLEEP', 'SPDKL_CurrentUser',
    'SPPS_Noncontent', 'DISPID_SPAsItem', 'SSSPTRelativeToEnd',
    'SpeechStreamFileMode', 'DISPID_SFSClose', 'ISpeechVoiceStatus',
    'SVEBookmark', 'SPINTERFERENCE_LATENCY_WARNING',
    'SECFEmulateResult', 'SAFT24kHz16BitStereo',
    'DISPID_SRCRetainedAudio', '_ISpeechVoiceEvents',
    'DISPID_SGRClear', 'DISPID_SWFEBlockAlign',
    'DISPID_SRRSaveToMemory', 'DISPID_SRCEStartStream', 'SPSHT_OTHER',
    'SpMemoryStream', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPAStartElementInResult', 'ISpeechAudioFormat',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechPhoneConverter',
    'IEnumSpObjectTokens', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SpeechPhraseAlternate', 'ISpNotifySink', 'SPFM_CREATE',
    'DISPID_SDKEnumValues', 'SINone', 'SITooSlow',
    'SPWORDPRONUNCIATION', 'SVSFIsNotXML', 'SP_VISEME_13',
    'SFTSREngine', 'DISPID_SASetState', 'DISPID_SMSAMMHandle',
    'eLEXTYPE_PRIVATE8', 'SVP_6',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_PHONEME',
    'SRADefaultToActive', 'SPDKL_LocalMachine', 'SPVPRI_ALERT',
    'ISpGrammarBuilder', 'SRAORetainAudio', 'DISPID_SASNonBlockingIO',
    'SpeechCategoryAudioOut', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SpeechPhraseProperties', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPRulesItem', 'ISpRecognizer2', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVSFUnusedFlags',
    'SREFalseRecognition', 'DISPID_SVRate',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRGCommit',
    'DISPID_SGRSTType', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SWFEAvgBytesPerSec', 'SPPHRASEELEMENT',
    'SAFT11kHz16BitMono', 'SAFTADPCM_11kHzStereo', 'SLODynamic',
    ...
    'ISpeechPhraseReplacements', 'SpeechWordPronounceable',
    ...
    'DISPID_SPEAudioStreamOffset', 'SREPropertyNumChange',
    'SpObjectTokenCategory', 'ISpeechPhraseInfoBuilder',
    'SpeechAudioFormatGUIDText', 'DISPID_SpeechRecoResultTimes',
    'eLEXTYPE_RESERVED6', 'SAFTNonStandardFormat',
    'SpeechInterference', 'SAFT24kHz16BitMono',
    'SpeechVoiceCategoryTTSRate', 'SPSERIALIZEDPHRASE',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SDKGetStringValue',
    'SITooLoud', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechBookmarkOptions', 'SpNotifyTranslator',
    'eLEXTYPE_PRIVATE14', 'SPCT_DICTATION', 'DISPID_SRRAudio',
    'SPEI_START_SR_STREAM', 'ISpSerializeState', 'SpeechFormatType',
    'SREPrivate', 'SPPS_RESERVED3', 'ISpeechGrammarRules',
    'SAFTADPCM_44kHzMono', 'SpPhoneticAlphabetConverter',
    'SREPhraseStart', 'STCInprocServer', 'DISPID_SRCEEndStream',
    'DISPID_SLWsCount', 'SpeechRegistryLocalMachineRoot',
    'eLEXTYPE_PRIVATE18', 'DISPID_SPACommit',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechPhraseReplacement',
    'ISpeechAudio', 'SAFT16kHz8BitMono', 'SPVISEMES',
    'SSFMOpenReadWrite', 'SVEEndInputStream',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPIDSPRG', 'DISPID_SpeechVoice',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPPFirstElement',
    'SpeechCategoryRecoProfiles', 'SpeechSpecialTransitionType',
    'SPEI_VISEME', 'SVSFDefault', 'SDA_No_Trailing_Space',
    'ISpeechRecoContext', 'SPPS_RESERVED2', 'SpeechRunState',
    ...
    'SDTPronunciation', 'SPEI_RESERVED6', 'SSSPTRelativeToStart',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRRAudioFormat',
    'ISpLexicon', 'DISPID_SPIRule', 'SpResourceManager',
    'SpStreamFormatConverter', 'ISpAudio', 'SPRECOSTATE', 'SPAS_RUN',
    'SDKLLocalMachine', 'DISPID_SVSInputWordLength', 'SRAONone',
    'SP_VISEME_3', 'DISPID_SpeechObjectToken', 'DISPID_SDKCreateKey',
    'SpeechRecoProfileProperties', 'SPCS_DISABLED',
    'DISPID_SpeechLexiconWord', 'DISPID_SPRFirstElement', 'SVPNormal',
    'SRTAutopause', 'SpeechStreamSeekPositionType', 'SPAUDIOOPTIONS',
    'eLEXTYPE_RESERVED7', 'SPEI_RESERVED3', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SOTCreateInstance', 'DISPID_SRCEAudioLevel', 'SWTAdded',
    'SPEI_INTERFERENCE', 'DISPID_SOTRemove',
    ...
    'ISpMMSysAudio', 'SAFTCCITT_ALaw_22kHzStereo', 'SSTTDictation',
    'SAFTGSM610_8kHzMono', 'SAFT12kHz16BitStereo',
    'SPEI_START_INPUT_STREAM', 'SPEI_RESERVED1', 'SVSFIsFilename',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechRecognizer',
    'SPFM_NUM_MODES', 'SPWAVEFORMATTYPE', 'DISPID_SRRTTickCount',
    'DISPID_SRGId', 'DISPID_SRCERecognition', 'SAFTGSM610_22kHzMono',
    'SAFT48kHz16BitMono', 'SPPS_Interjection', 'SP_VISEME_12',
    'SPPROPERTYINFO', 'DISPID_SRIsUISupported',
    'eLEXTYPE_USER_SHORTCUT', 'SAFT16kHz16BitStereo',
    'DISPID_SOTCGetDataKey', 'DISPID_SOTSetId', 'DISPID_SRGReset',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRsItem', 'SpNullPhoneConverter', 'SVEWordBoundary',
    'SPPS_NotOverriden', 'SP_VISEME_5', 'DISPID_SPIStartTime',
    'DISPID_SRCResume', 'DISPID_SWFEChannels', 'ISequentialStream',
    'SVP_18', 'SPPS_SuppressWord', 'DISPID_SVSRunningState',
    'ISpeechPhraseInfo', 'DISPID_SRGState', 'SPEI_SR_BOOKMARK',
    'DISPID_SGRSTsItem', 'eLEXTYPE_PRIVATE13', 'ISpObjectToken',
    'LONG_PTR', 'ISpeechAudioBufferInfo', 'SVSFVoiceMask',
    'SP_VISEME_6', 'SPXMLRESULTOPTIONS', 'DISPID_SRSetPropertyNumber',
    'SDKLDefaultLocation', 'DISPID_SPISaveToMemory',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SITooQuiet',
    'SVEVoiceChange', 'SAFT22kHz16BitMono', 'SVSFPersistXML',
    'ISpVoice', 'DISPID_SAStatus', 'SAFT48kHz16BitStereo',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SABIMinNotification',
    ...
    'SPPARTOFSPEECH', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRSClsidEngine',
    'DISPID_SPRuleFirstElement', 'SAFT44kHz16BitMono', 'DISPIDSPTSI',
    'DISPID_SVGetVoices', 'DISPID_SpeechLexiconWords',
    'DISPID_SRIsShared', 'DISPID_SRCVoice', 'SVSFParseSapi',
    'DISPID_SPRuleId', 'ISpeechPhraseRule', 'eLEXTYPE_PRIVATE19',
    'UINT_PTR', 'DISPID_SGRInitialState', 'SPAS_PAUSE', 'SDTAudio',
    'SPAR_Medium', 'SPLEXICONTYPE', 'SPSLMA', 'SVP_14', 'SVP_11',
    'SVP_8', 'ISpeechFileStream', 'DISPID_SRRTStreamTime',
    'ISpPhraseAlt', 'SPSNoun', 'SPPS_Verb', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRGCmdLoadFromObject', 'Speech_Max_Word_Length',
    'ISpeechPhoneConverter', 'DISPID_SGRsAdd', 'SpeechUserTraining',
    'ISpeechLexiconWord', 'DISPID_SREmulateRecognition',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SpeechBaseStream',
    'SPSHORTCUTPAIR', 'ISpeechPhraseAlternate', 'SDTReplacement',
    'SPRECOCONTEXTSTATUS', 'SpeechRecognitionType',
    'DISPID_SpeechObjectTokenCategory', 'ISpRecoCategory',
    'DISPID_SPRs_NewEnum', 'SpeechPropertyHighConfidenceThreshold',
    'SpeechDisplayAttributes', 'SVP_21', 'SPAO_RETAIN_AUDIO',
    'SPEI_FALSE_RECOGNITION', 'SpeechVoiceSpeakFlags',
    'SPBINARYGRAMMAR', 'SPSEMANTICERRORINFO', 'ISpPhoneConverter',
    'SpVoice', 'SGDSInactive', 'ISpRecognizer3',
    'SpeechRecoContextState', 'SPAUDIOSTATUS', 'SRESoundStart',
    'SPGRAMMARWORDTYPE', 'SSFMCreateForWrite', 'DISPID_SOTCDefault',
    'SpeechCategoryRecognizers', 'SPSFunction', 'SSFMCreate',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRGDictationUnload', 'SAFTCCITT_uLaw_22kHzMono',
    'SPRECORESULTTIMES', 'SRESoundEnd', 'DISPID_SVSLastBookmark',
    'SPEI_TTS_PRIVATE', 'SPPS_Unknown', 'SRTEmulated',
    'DISPID_SMSGetData', 'SREAllEvents', 'SRCS_Disabled', 'SVF_None',
    'SpeechVisemeFeature', 'ISpRecoGrammar', 'DISPID_SADefaultFormat',
    'SpeechAllElements', 'SPSHT_Unknown', 'ISpResourceManager',
    'DISPID_SAFGetWaveFormatEx', 'SPAS_STOP',
    'SpeechRetainedAudioOptions', 'SAFTADPCM_22kHzStereo',
    'SPSMF_UPS', 'DISPID_SPIAudioSizeTime', 'DISPID_SVSLastResult',
    'DISPID_SRGSetTextSelection', 'DISPID_SLPLangId',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRRecognizer',
    'SPWORDTYPE', 'SPEI_SOUND_START', 'SRSActive',
    'SPEI_VOICE_CHANGE', 'DISPID_SRState', 'SVP_7',
    'SpeechRuleAttributes', 'SPEI_WORD_BOUNDARY',
    'SpeechGrammarWordType', 'DISPID_SVSLastBookmarkId',
    'DISPID_SAFGuid', 'SpFileStream', 'DISPID_SVEventInterests',
    'DISPID_SOTsCount', 'DISPID_SVSInputSentencePosition',
    'DISPID_SVDisplayUI', 'SpeechGrammarTagDictation',
    'DISPID_SGRSTPropertyId', 'eLEXTYPE_RESERVED4',
    'ISpeechRecoGrammar', 'DISPID_SLWWord', 'SPCS_ENABLED',
    'DISPID_SPRulesCount', 'ISpEventSink', 'DISPID_SRAudioInput',
    'DISPID_SOTCEnumerateTokens', 'SRERecoOtherContext', 'SPPS_Noun',
    'SGRSTTWildcard', 'DISPID_SPPEngineConfidence',
    'DISPID_SVGetAudioOutputs', 'SAFTText', 'DISPID_SBSFormat',
    'DISPID_SPIReplacements', 'SpeechMicTraining',
    'DISPID_SDKGetlongValue', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPCIdToPhone', 'SAFT32kHz16BitMono', 'SpAudioFormat',
    'SRAImport', 'SASRun', 'SpeechVoicePriority',
    'DISPID_SRSSupportedLanguages', 'DISPID_SVVoice',
    'DISPID_SVSpeak', 'SpeechDataKeyLocation', 'SREInterference',
    ...
    'ISpeechPhraseAlternates', 'SVP_17', 'SRTSMLTimeout',
    'eLEXTYPE_RESERVED9', 'SAFTCCITT_ALaw_8kHzStereo',
    'SpeechCategoryVoices', 'SPEI_SR_AUDIO_LEVEL',
    'SPEI_TTS_AUDIO_LEVEL', 'ISpeechLexiconPronunciations',
    'SDA_One_Trailing_Space', 'SVSFParseMask', 'SPCONTEXTSTATE',
    'DISPID_SAFType', 'SPEI_SR_RETAINEDAUDIO', 'DISPID_SMSALineId',
    'SpPhoneConverter', 'SAFT8kHz16BitStereo', 'eLEXTYPE_APP',
    'SSFMOpenForRead', 'DISPID_SFSOpen',
    'SpeechCategoryPhoneConverters', 'SPVPRI_OVER', 'SRATopLevel',
    'STSF_LocalAppData', 'SPINTERFERENCE_NONE',
    'DISPID_SRCEHypothesis', 'DISPID_SRRRecoContext',
    'SPEI_END_SR_STREAM', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechLoadOption', 'SGRSTTDictation',
    'DISPID_SPERetainedSizeBytes', 'ISpeechTextSelectionInformation',
    'SDTRule', 'IEnumString', 'SPRULE', 'DISPID_SOTDisplayUI',
    'DISPID_SPAsCount', 'DISPID_SRGDictationLoad', 'DISPID_SVStatus',
    'SpeechTokenKeyFiles', 'DISPID_SGRSAddRuleTransition',
    'ISpStream', 'SAFT16kHz8BitStereo',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPSHT_NotOverriden',
    'SVEAllEvents', 'SPGS_ENABLED', 'DISPID_SLWsItem',
    'SRSActiveAlways', 'SDTAll', 'SpSharedRecoContext',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT11kHz16BitStereo',
    'SVSFNLPSpeakPunc', 'ISpPhoneticAlphabetSelection',
    'DISPID_SLAddPronunciation', 'SPPHRASEPROPERTY',
    'DISPID_SRRTLength', 'DISPID_SOTs_NewEnum',
    'DISPID_SRGRecoContext', 'ISpPhoneticAlphabetConverter',
    'SPFILEMODE', 'SGDSActiveUserDelimited', 'DISPID_SLGetWords',
    'SVSFNLPMask', 'SpeechAddRemoveWord', 'DISPID_SGRSTRule',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SOTIsUISupported', 'SDTAlternates',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRSetPropertyString', 'ISpRecoGrammar2',
    'SPRST_ACTIVE_ALWAYS', 'SAFT22kHz8BitStereo',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SAVolume',
    'SPTEXTSELECTIONINFO', 'SAFT32kHz8BitMono', 'SRSEIsSpeaking',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SDA_Consume_Leading_Spaces',
    'SPFM_OPEN_READONLY', 'DISPID_SABIEventBias',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRRDiscardResultInfo',
    'SpeechTokenContext', 'SPEI_UNDEFINED', 'DISPID_SRGetFormat'
]

_check_version('1.1.14', 1610707580.034558)
